...
namespace WpfApplication3
{
    ...
    public class SqlHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public void getConnectString(string connectionName)
        {
        ...
        //public static readonly string connectionString = getConnectString("con_Infocenter");
        ...
        public void PrepareCommand(SqlCommand cmd, SqlConnection conn, SqlTransaction trans, CommandType cmdType, string cmdText, SqlParameter[] cmdParms)
        {
            //判断数据库连接状态
